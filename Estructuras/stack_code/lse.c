...
void imprime(Lista tad){
    ...
    while(recorrido != NULL){
        ...
        printf(" %c - %d ", recorrido->elemento.value, recorrido->elemento.weight);        
...
NodoLista *obtener_nodo_anterior(Lista tad, ElementoLista elemento){
    ...
    NodoLista* recorrido = tad.cabeza;
    while(recorrido != NULL && recorrido->elemento.weight < elemento.weight){
        anterior = recorrido;        
        recorrido = recorrido->sig;
    }
    return anterior;    
...
NodoLista* se_encuentra(Lista tad, ElementoLista llave){
    NodoLista* recorrido = tad.cabeza;
    while(recorrido != NULL && recorrido->elemento.value!= llave.value){        
        recorrido = recorrido->sig;
    }
    return recorrido;        
}
...
void elimina_nodo(Lista *tad, ElementoLista elemento){
    NodoLista *ultimo=NULL;
    NodoLista *recorrido = tad->cabeza;
    while(recorrido != NULL && recorrido->elemento.value!=elemento.value){
        ultimo = recorrido;        
        recorrido = recorrido->sig;
    }
    if (recorrido != NULL){

...
Nodo *crear_nuevo_nodo(ElementoLista, DiaLista, Nodo *);
Nodo *obtener_ultimo_nodo(Lista);
Nodo *obtener_nodo_anterior(Lista, ElementoLista);
void insertar_al_inicio(Lista *, ElementoLista, DiaLista);
void insertar_al_final(Lista *, ElementoLista, DiaLista);
void insertar_en_orden(Lista *, ElementoLista, DiaLista);
void imprime(Lista);
int longitud(Lista);
